    ...
    public class CampanhaSaldoClienteController : ControllerBase
    {
        ...
        public JsonResult Post(CampanhaSaldoCliente camp)
        {
            ...
            string query = @"
                            ...
                            (ID_Campanha, DT_Inicio, ID_Cliente, Saldo, Saldo_Apropriado, Saldo_Disponivel)
                            values (@ID_Campanha, @DT_Inicio, @ID_Cliente, @Saldo, @Saldo_Apropriado,  @Saldo_Disponivel)
                            ";
            ...
            using (SqlConnection myCon = new SqlConnection(sqlDataSource))
            {
                ...
                using (SqlCommand myCommand = new SqlCommand(query, myCon))
                {
                    ...
                    myCommand.Parameters.AddWithValue("@Saldo", camp.Saldo);
        ...
        [HttpPut("{id}")]
        public JsonResult Put(CampanhaSaldoCliente camp, int id)
        {
            string query = @"
